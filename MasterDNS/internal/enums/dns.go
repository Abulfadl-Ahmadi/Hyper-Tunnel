...
const (
	...
	// Hybrid tunnel control packets (Phase 2)
	PACKET_HYBRID_STREAM_OPEN       = 0x38 // 56
	PACKET_HYBRID_STREAM_OPEN_ACK   = 0x39 // 57
	PACKET_HYBRID_STREAM_CLOSE      = 0x3A // 58
	PACKET_HYBRID_STREAM_CLOSE_ACK  = 0x3B // 59
	PACKET_HYBRID_STREAM_RESET      = 0x3C // 60
	PACKET_HYBRID_STREAM_RESET_ACK  = 0x3D // 61
	PACKET_HYBRID_DOWN_ACK          = 0x3E // 62
	PACKET_HYBRID_DOWN_NACK         = 0x3F // 63
	PACKET_HYBRID_STATS             = 0x40 // 64
	PACKET_HYBRID_HEARTBEAT         = 0x41 // 65
	PACKET_HYBRID_KEY_ROTATION      = 0x42 // 66
