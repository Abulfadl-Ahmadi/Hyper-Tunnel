...
func PacketTypeName(packetType uint8) string {
	...
	case PACKET_HYBRID_STREAM_OPEN:
		return "PACKET_HYBRID_STREAM_OPEN"
	case PACKET_HYBRID_STREAM_OPEN_ACK:
		return "PACKET_HYBRID_STREAM_OPEN_ACK"
	case PACKET_HYBRID_STREAM_CLOSE:
		return "PACKET_HYBRID_STREAM_CLOSE"
	case PACKET_HYBRID_STREAM_CLOSE_ACK:
		return "PACKET_HYBRID_STREAM_CLOSE_ACK"
	case PACKET_HYBRID_STREAM_RESET:
		return "PACKET_HYBRID_STREAM_RESET"
	case PACKET_HYBRID_STREAM_RESET_ACK:
		return "PACKET_HYBRID_STREAM_RESET_ACK"
	case PACKET_HYBRID_DOWN_ACK:
		return "PACKET_HYBRID_DOWN_ACK"
	case PACKET_HYBRID_DOWN_NACK:
		return "PACKET_HYBRID_DOWN_NACK"
	case PACKET_HYBRID_STATS:
		return "PACKET_HYBRID_STATS"
	case PACKET_HYBRID_HEARTBEAT:
		return "PACKET_HYBRID_HEARTBEAT"
	case PACKET_HYBRID_KEY_ROTATION:
		return "PACKET_HYBRID_KEY_ROTATION"
