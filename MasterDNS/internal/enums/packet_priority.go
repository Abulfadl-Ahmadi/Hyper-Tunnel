...
func DefaultPacketPriority(packetType uint8) int {
	...
	case PACKET_STREAM_DATA_ACK,
		...
		PACKET_HYBRID_STREAM_OPEN_ACK,
		PACKET_HYBRID_STREAM_CLOSE,
		PACKET_HYBRID_STREAM_CLOSE_ACK,
		PACKET_HYBRID_STREAM_RESET,
		PACKET_HYBRID_STREAM_RESET_ACK,
		PACKET_HYBRID_DOWN_ACK,
		PACKET_HYBRID_DOWN_NACK,
		PACKET_HYBRID_STATS,
		PACKET_HYBRID_HEARTBEAT,
		PACKET_HYBRID_KEY_ROTATION,
		PACKET_STREAM_SYN,
