...
func TestDefaultPacketPriorityMatchesCurrentBehavior(t *testing.T) {
	tests := map[uint8]int{
		...
		PACKET_HYBRID_STREAM_OPEN:      PacketPriorityCritical,
		PACKET_HYBRID_STREAM_OPEN_ACK:  PacketPriorityCritical,
		PACKET_HYBRID_STREAM_CLOSE:     PacketPriorityCritical,
		PACKET_HYBRID_STREAM_CLOSE_ACK: PacketPriorityCritical,
		PACKET_HYBRID_STREAM_RESET:     PacketPriorityCritical,
		PACKET_HYBRID_STREAM_RESET_ACK: PacketPriorityCritical,
		PACKET_HYBRID_DOWN_ACK:         PacketPriorityCritical,
		PACKET_HYBRID_DOWN_NACK:        PacketPriorityCritical,
		PACKET_HYBRID_STATS:            PacketPriorityCritical,
		PACKET_HYBRID_HEARTBEAT:        PacketPriorityCritical,
		PACKET_HYBRID_KEY_ROTATION:     PacketPriorityCritical,
